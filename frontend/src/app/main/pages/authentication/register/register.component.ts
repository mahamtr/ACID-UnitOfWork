...
import { AuthenticationService } from 'app/generatedServices/api/authentication.service';
...
export class RegisterComponent implements OnInit, OnDestroy
{
    ...
    register (): void{
        ...
        this._authService.apiAuthenticationRegisterPost({userName:name,passWord:password}).subscribe(res=>{
