>## NOTE: This repo is a fork of Steve Smith's [Clean Architecture](https://github.com/ardalis/backend) repo with additional code to facilitate publication as a [Visual Studio extension](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.backend). 
> [More info](https://github.com/GregTrevellick/backend#the-fork)
 

<!--BadgesSTART-->
<!-- Powered by https://github.com/GregTrevellick/ReadMeSynchronizer -->
[![Read Me Synchronizer](https://img.shields.io/badge/-powered%20by%20ReadMeSynchronizer-brightgreen.svg)](https://github.com/GregTrevellick/ReadMeSynchronizer)
[![BetterCodeHub compliance](https://bettercodehub.com/edge/badge/GregTrevellick/backend?branch=master)](https://bettercodehub.com/results/GregTrevellick/backend)
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/3b74ee0e8da64daf94199f8a7f2fcf12)](https://www.codacy.com/project/gtrevellick/backend/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=GregTrevellick/backend&amp;utm_campaign=Badge_Grade_Dashboard)
 [![CodeFactor](https://www.codefactor.io/repository/github/GregTrevellick/backend/badge)](https://www.codefactor.io/repository/github/GregTrevellick/backend)
...
[![LGTM Alerts](https://img.shields.io/lgtm/alerts/g/ardalis/backend.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/ardalis/backend/alerts/)
[![Language grade: JavaScript](https://img.shields.io/lgtm/grade/javascript/g/ardalis/backend.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/ardalis/backend/context:javascript)
[![GitHub top language](https://img.shields.io/github/languages/top/GregTrevellick/backend.svg)](https://github.com/GregTrevellick/backend)
[![Github language count](https://img.shields.io/github/languages/count/GregTrevellick/backend.svg)](https://github.com/GregTrevellick/backend)
 [![GitHub issues](https://img.shields.io/github/issues-raw/GregTrevellick/backend.svg)](https://github.com/GregTrevellick/backend/issues)
[![GitHub pull requests](https://img.shields.io/github/issues-pr-raw/GregTrevellick/backend.svg)](https://github.com/GregTrevellick/backend/pulls)
[![GitHub followers](https://img.shields.io/github/followers/GregTrevellick.svg)](https://github.com/GregTrevellick?tab=followers)
[![GitHub stars](https://img.shields.io/github/stars/GregTrevellick/backend.svg)](https://github.com/GregTrevellick/backend)
[![GitHub watchers](https://img.shields.io/github/watchers/GregTrevellick/backend.svg)](https://github.com/GregTrevellick/backend/watchers)
[![Sonar&metric=alert_status](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=alert_status)](https://sonarcloud.io/dashboard?id=backend)
[![Sonar&metric=bugs](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=bugs)](https://sonarcloud.io/component_measures?id=backend&metric=bugs)
[![Sonar&metric=code_smells](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=code_smells)](https://sonarcloud.io/component_measures?id=backend&metric=code_smells)
[![Sonar&metric=coverage](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=coverage)](https://sonarcloud.io/component_measures?id=backend&metric=Coverage)
[![Sonar&metric=duplicated_lines_density](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=duplicated_lines_density)](https://sonarcloud.io/component_measures?id=backend&metric=duplicated_lines)
[![Sonar&metric=ncloc](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=ncloc)](https://sonarcloud.io/component_measures?id=backend&metric=ncloc)
[![Sonar&metric=reliability_rating](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=reliability_rating)](https://sonarcloud.io/component_measures?id=backend&metric=reliability_rating)
[![Sonar&metric=security_rating](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=security_rating)](https://sonarcloud.io/component_measures?id=backend&metric=security_rating)
[![Sonar&metric=sqale_index](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=sqale_index)](https://sonarcloud.io/component_measures?id=backend&metric=sqale_index)
[![Sonar&metric=sqale_rating](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=sqale_rating)](https://sonarcloud.io/component_measures?id=backend&metric=sqale_rating)
[![Sonar&metric=vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=backend&metric=vulnerabilities)](https://sonarcloud.io/component_measures?id=backend&metric=vulnerabilities)
[![Appveyor Build status](https://ci.appveyor.com/api/projects/status/6raa1n0tucf66h0q?svg=true)](https://ci.appveyor.com/project/GregTrevellick/backend)
[![Appveyor unit tests](https://img.shields.io/appveyor/tests/GregTrevellick/backend.svg)](https://ci.appveyor.com/project/GregTrevellick/backend/build/tests)
[![Azure Build Status](https://gregtrevellick.visualstudio.com/backend/_apis/build/status/backend)](https://gregtrevellick.visualstudio.com/backend/_build/latest?definitionId=41)
...
[![Subscribe](https://img.shields.io/badge/subscribe%20to%20receive%20notificatons-grey.svg)](https://github.com/GregTrevellick/backend/subscription)
[![](https://codescene.io/projects/7067/status.svg)](https://codescene.io/projects/7067/jobs/latest-successful/results)

[![Visual Studio Marketplace version](https://img.shields.io/badge/-backend-%23e2165e.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.backend)
[![Visual Studio Marketplace downloads](https://vsmarketplacebadge.apphb.com/installs/GregTrevellick.backend.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.backend)
[![Visual Studio Marketplace ratings](https://vsmarketplacebadge.apphb.com/rating/GregTrevellick.backend.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.backend)
[![Visual Studio Marketplace version](https://vsmarketplacebadge.apphb.com/version/GregTrevellick.backend.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.backend)
...
## *Now available as a [project template](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.backend) within Visual Studio.*

## Versions

The master branch is now using .NET Core Version 3.1. If you need a 2.x version use one of these tagged commits:

- [2.2](https://github.com/ardalis/backend/tree/dotnet-core-2.2)
- [2.0](https://github.com/ardalis/backend/tree/dotnet-core-2.0)
...
- [Install the Visual Studio Template](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.backend) and use it within Visual Studio
...
[Steve 'ardalis' Smith](https://github.com/ardalis/backend)
